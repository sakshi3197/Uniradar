...
const Profile = () => {
  ...
  `;
    ...
    useEffect(() => {
        ...
        axios.post('https://healthmate-backend.onrender.com/fetch_details', formData).then(response => {
...
const handleSubmit = event => {
  ...
  axios.post('https://healthmate-backend.onrender.com/update_user', user).then(response => {
      ...
      const handleDelete = event => {
        ...
        formData.username = userEmail;
        console.log("EMAIL:", formData.username);
        axios.post('https://healthmate-backend.onrender.com/delete_account', formData).then(response => {
